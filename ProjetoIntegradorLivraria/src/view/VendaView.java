...
public class VendaView extends javax.swing.JFrame {
    ...
    public VendaView() {
        ...
        JTableController.carregarClientes(tbClientes, 1, "");
        JTableController.carregarProdutos(tbProdutos, 1, "");
        jdcDtVenda.setDate(new java.util.Date());
    }
    ...
    private void initComponents() {
        ...
        cboCampoProduto = new javax.swing.JComboBox<>();
        ...
        cboCampoCliente.setSelectedIndex(1);
        ...
        cboCampoProduto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Título" }));
        cboCampoProduto.setSelectedIndex(1);

        txtFiltrarProduto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtFiltrarProdutoKeyReleased(evt);
            }
        });
        ...
        tbProdutos.setToolTipText("adicionar produto");
        tbProdutos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        livroLayout.setHorizontalGroup(
            ...
            .addGroup(livroLayout.createSequentialGroup()
                ...
                .addGroup(livroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtFiltrarProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 452, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(livroLayout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addGap(18, 18, 18)
                        .addComponent(cboCampoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        livroLayout.setVerticalGroup(
            ...
            .addGroup(livroLayout.createSequentialGroup()
                ...
                .addGroup(livroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cboCampoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void txtFiltrarClienteKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFiltrarClienteKeyReleased
        ...
        int campo = cboCampoCliente.getSelectedIndex();
        String filtro = txtFiltrarCliente.getText();
        
        JTableController.carregarClientes(tbClientes, campo, filtro);
    ...
    private void txtFiltrarProdutoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFiltrarProdutoKeyReleased
        // TODO add your handling code here:
        int campo = cboCampoProduto.getSelectedIndex();
        String filtro = txtFiltrarProduto.getText();

        if (filtro.equals("")) {
            JTableController.carregarProdutos(tbProdutos, 1, filtro);
        } else {
            JTableController.carregarProdutos(tbProdutos, campo, filtro);
        }
    }//GEN-LAST:event_txtFiltrarProdutoKeyReleased

    private void tbProdutosMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbProdutosMouseReleased
        // TODO add your handling code here:
        JTableController.adicionarProduto(tbProdutos, tbVenda, lblTotal);
    ...
    private void btnEfetuarVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEfetuarVendaActionPerformed
        ...
        for (int i = 0; i < tbVenda.getRowCount(); i++) {
            ...
            cadastrado = ProdutoDAO.Atualizar(idLivro, qtdEstoque - qtdLivro);
        ...
        if (cadastrado) {
            ...
            JOptionPane.showMessageDialog(this, "Erro ao efetuar a venda");            
        }
    ...
    private javax.swing.JComboBox<String> cboCampoProduto;
